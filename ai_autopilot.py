...
def is_skippable(project: dict):
    """Возвращает ключевое слово-причину, если заявка про конструкторы/CMS, иначе None."""
...
def ai_compose(project: dict) -> dict:
    ...
    sys_prompt = (
        ...
        "помощь со стримами/трансляциями, консультации, моды к играм без программирования. "
