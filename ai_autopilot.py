...
PRICE_GUIDE = os.environ.get("KWORK_PRICE_GUIDE", (
    "Прайс-ориентиры исполнителя (отталкивайся от них, оценивая сложность):\n"
    "- Простой лендинг под ключ — от 25 000 ₽.\n"
    "- Telegram-бот — максимум ~10 000 ₽.\n"
    "- Сайт-каталог / интернет-магазин (каталог, корзина, оплата, базовое SEO) — "
    "от 80 000 ₽ и выше в зависимости от объёма.\n"
    "Логика: бери опорную ставку для близкого типа проекта и масштабируй по "
    "сложности (больше функций/интеграций/страниц — выше цена; совсем простая "
    "доработка — ниже). Цены ориентировочные, думай как инженер."
))
